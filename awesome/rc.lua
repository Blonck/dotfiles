...
cmd_vol_down   = "amixer " .. snd_device .. " -q sset Master 4%-"
cmd_vol_up     = "amixer " .. snd_device .. " -q sset Master 4%+"
...
terminals = { "gnome-terminal", "urxvt", "xterm", "x-terminal-emulator" } 
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "F2",
        function () awful.util.spawn("gvim", false) end),
